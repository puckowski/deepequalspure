...
export class SimpleDeepEqualBenchmark {
  ...
  constructor(private ngxDeepEquals: any) {
    this.isMatch = [];
    this.isMatchLodash = [];
  ...
  private warmup(): void {
    for (let i = 0; i < 10; ++i) {
      this.ngxDeepEquals(this.obj1, this.obj2);
      this.ngxDeepEquals(this.obj1, this.obj3);
      this.ngxDeepEquals(this.obj1, this.obj4);
      this.ngxDeepEquals(this.obj1, this.obj5);
      this.ngxDeepEquals(this.obj1, this.obj6);
      this.ngxDeepEquals(this.obj1, this.obj7);
      this.ngxDeepEquals(this.obj8, this.obj9);
    }
  ...
  private runSimpleBenchmark(): void {
    ...
    for (let n = 0; n < this.DEFAULT_BENCH_RUNS; ++n) {
      ...
      for (let i = 0; i < this.DEFAULT_BENCH_ITERATIONS; ++i) {
        let res1 = this.ngxDeepEquals(this.obj1, this.obj2);
        res1 = this.ngxDeepEquals(this.obj1, this.obj3);
        res1 = this.ngxDeepEquals(this.obj1, this.obj4);
        res1 = this.ngxDeepEquals(this.obj1, this.obj5);
        res1 = this.ngxDeepEquals(this.obj1, this.obj6);
        res1 = this.ngxDeepEquals(this.obj1, this.obj7);
        res1 = this.ngxDeepEquals(this.obj8, this.obj9);
      }
